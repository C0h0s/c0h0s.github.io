...
const WebsitesSection = () => {
  ...
  return <section className="py-16 px-4 bg-gaming-dark">
      <div className="container mx-auto">
        ...
        <div className="flex justify-center">
          {websites.map(site => <motion.div key={site.url} className="bg-secondary/20 rounded-xl overflow-hidden cursor-pointer max-w-md w-full" whileHover={{
          scale: 1.02
        }} transition={{
          duration: 0.3
        }}>
              <div className="p-6">
                ...
                <Button variant="ghost" className="mt-2 text-white hover:bg-white/10" onClick={() => window.open(site.url, '_blank')}>
                  Visit Website
